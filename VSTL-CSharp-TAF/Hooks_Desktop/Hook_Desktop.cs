...
namespace CSharpTAF.Hooks_Desktop
{

//    [Binding]
    public sealed class Hook_Desktop : DesktopDriver
    {
        ...
        public void InsertReportingSteps()
        {
            ...
            string screenShot = Pojo.getTestUtils().readConfigFile("IsScreenShotReqdAtEveryStep");
            ...
            if (ScenarioContext.Current.TestError == null)
            {
                ...
                string directory1 = Path.GetDirectoryName(filePath1);
                ...
                var mediaEntity = new ParallelConfigForDesktop().CaptureScreenshotAndReturnModel(ScenarioContext.Current.ScenarioInfo.Title.Trim());
                if (stepType == "Given")
                {
